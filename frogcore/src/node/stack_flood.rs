...
use super::{meshtastic::MeshtasticRadioInterface, GlobalPacketId, ImplNodeModel, StoredPacket};
...
impl ImplNodeModel for StackFlood {
    ...
    fn receive_message(
        ...
        if !packet.header.dest.is_to_node(context.node_id()) {
            ...
            self.radio_interface.priority_send(&mut context, packet);
        }
